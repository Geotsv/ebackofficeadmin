...
class TaskListIndex extends React.Component {
    ...
    render() {
        ...
        const columns = ['id', 'customer_code', 'name', 'duedate', 'priority', 'status', 'assigneeNames', 'actions']
        ...
        const options = {
            ...
            sortable: ['name', 'customer_code','description', 'duedate', 'priority', 'status', 'assigneeNames',],
